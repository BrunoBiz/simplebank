...
// Will contain the input params of the transfer trasaction
...
// Will contain the results of the transfer transaction
...
// Will create a transferRecord, add entries, and update the accounts' balance within a single db transaction
